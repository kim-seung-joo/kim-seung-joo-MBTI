...
const qnaList = [
  ...
  {
    q: '질문5. 오늘 연인과 첫 데이트 하는 날이다. 첫 날 허용할 수 있는 스킨십의 범위는?',
    a: [
  ...
  {
    q: '질문6. 기념일이 다가온다. 당신은 어떻게 할 것인가? (ex - 100, 200일)',
    a: [
  ...
  {
    q: '질문8. 연인이 데이트가 끝난 후, 집에 데려다 달라고 한다',
    a: [
  ...
  {
    q: '질문10. 연인이 연락도 없이 보고싶다고 우리집 앞에 와서 기다린다. ',
    a: [
  ...
  {
    q: '질문12. 연인과 데이트 도중 화를 참을 수 없을만큼 심하게 싸웠다. 어떻게 할 것인가?',
    a: [
